...
| `/centers` | `app/centers/page.tsx` | Серверная страница: список активных сервисных центров из БД, карта, список СЦ по городам (заголовок города + карточки, города по алфавиту) |
