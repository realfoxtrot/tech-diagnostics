    ...
    <main className="flex-1">
          ...
          <div className="bg-card border border-border rounded-xl p-8 text-center shadow-[0_1px_3px_rgba(16,35,58,0.06)]">
            ...
            <div className="mt-6 pt-6 border-t border-border grid grid-cols-2 gap-4 text-sm">
              ...
              <div>
                ...
                <div className="text-muted mt-1">в службе поддержки</div>
                <div className="font-semibold text-foreground mt-1">тел. 8 800 100-27-87</div>
                <div className="mt-1">
                  <Link href="/support" className="font-semibold text-accent hover:text-accent-hover">Запрос</Link>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="bg-card border-y border-border py-16">
        <div className="max-w-4xl mx-auto px-4 grid md:grid-cols-3 gap-6 text-center">
          {[
            { t: "Интерактивная диагностика", d: "Онлайн-диагностика, проверка гарантийности и техдокумент - сэкономят ваше время." },
