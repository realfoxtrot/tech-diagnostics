...
2. `5e511fa` — лендинг, карточка гарантий: «…техдокумент - сэкономят ваше время»; `539ff21` — description в metadata: «поможем продиагностировать, проконсультируем или починим, если необходимо».
