...
2. `6e05543`, `52e40a3`-fix — лендинг, статблок сети: вместо «24/7 техподдержка» — «Комманда профессионалов / в службе поддержки / тел. 8 800 100-27-87 / Запрос» (телефон и «Запрос» — жирным с новой строки, «Запрос» → /support).
